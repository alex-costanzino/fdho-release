"""
SIREN: sine-activated implicit neural representation.

Sitzmann et al., "Implicit Neural Representations with Periodic Activation
Functions", NeurIPS 2020.
Reference implementation: https://github.com/vsitzmann/siren
"""
...
class Siren(nn.Module):
    def __init__(self, in_features, hidden_features, hidden_layers, out_features, outermost_linear = False, first_omega_0 = 30.0, hidden_omega_0 = 30.0):
        super().__init__()
